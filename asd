--converted to fe by swaggermasteryolo
--listen to lovers leap while playing
local p = game.Players.LocalPlayer
local char = p.Character.swagRE
...
Align(Hat.Handle,AlignChar.swagRE.Torso.Bong.Stem,Vector3.new(-2.3,2,0),Vector3.new(0,0,60))
